...
@Component({
  selector: 'app-manutagua',
  templateUrl: './manutagua.component.html',
  styleUrls: ['./manutagua.component.css'],
  providers: [MessageService]
})
export class ManutaguaComponent implements OnInit, OnChanges {
  ...
  constructor(private IndicadoresService: IndicadoresService,
      ...
      this.indicador = "Manutencao Agua"
  }
 ...
 pesquisar(date6){
  ...
  .subscribe(
    indicadores  => {
      ...
      this.eqp = indicadores[0].atendente
