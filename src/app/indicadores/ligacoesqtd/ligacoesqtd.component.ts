...
@Component({
  selector: 'app-ligacoesqtd',
  templateUrl: './ligacoesqtd.component.html',
  styleUrls: ['./ligacoesqtd.component.css'],
  providers: [MessageService]
})
export class LigacoesqtdComponent implements OnInit, OnChanges {
