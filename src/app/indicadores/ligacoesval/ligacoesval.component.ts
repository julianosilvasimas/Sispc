...
@Component({
  selector: 'app-ligacoesval',
  templateUrl: './ligacoesval.component.html',
  styleUrls: ['./ligacoesval.component.css'],
  providers: [MessageService]
})
export class LigacoesvalComponent implements OnInit, OnChanges {
