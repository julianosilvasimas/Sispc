...
@Component({
  selector: 'app-tmecall',
  templateUrl: './tmecall.component.html',
  styleUrls: ['./tmecall.component.css'],
  providers: [MessageService]
})
export class TmecallComponent implements OnInit, OnChanges {
  ...
  constructor(private IndicadoresService: IndicadoresService,
      ...
      this.indicador = "TME Call Center"
  }
