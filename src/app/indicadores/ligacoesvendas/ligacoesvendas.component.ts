...
@Component({
  selector: 'app-ligacoesvendas',
  templateUrl: './ligacoesvendas.component.html',
  styleUrls: ['./ligacoesvendas.component.css'],
  providers: [MessageService]
})
export class LigacoesvendasComponent implements OnInit, OnChanges {
  ...
  constructor(private IndicadoresService: IndicadoresService,
      ...
      this.indicador = "Ligacoes - vendas Qtd"
  }
