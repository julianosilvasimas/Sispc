...
@Component({
  selector: 'app-telecobranca',
  templateUrl: './telecobranca.component.html',
  styleUrls: ['./telecobranca.component.css'],
  providers: [MessageService]
})
export class TelecobrancaComponent implements OnInit, OnChanges {
